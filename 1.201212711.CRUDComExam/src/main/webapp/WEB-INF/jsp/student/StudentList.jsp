...
<body>
	<div data-role='page' id='studentList' data-theme='c'>
		<div data-role='header'>
			<a data-icon='action' data-iconpos='notext' href="/web/student/addStudentView.do">등록</a>
			<h3>학생 정보 목록</h3>		
		</div>
			...
			<form:form commandName="searchVO" name="listForm" id="listForm"
				...
				<div id="content_pop">
					...
					<ul data-role='listview' data-inset='true' data-theme='c'>
						<li data-role='listview-driver'><a data-ajax='false' data-icon='action' data-iconpos='notext' data-type='button' href="/CRUDComExam/student/addStudentView.do">등록</a></li>
					</ul>
				</div>
			</form:form>
		</div>
